...
#Preview {
    ZenMetricStrip(values: [
        ZenMetricValue(label: "Clicks", value: "694", tint: .zenAccent, iconSource: .hugeIcon(.cursorarrowClick2), comparisonValue: "+120", comparisonDetail: "(+20%)", trend: .up),
        ZenMetricValue(label: "Impressions", value: "17.8K", tint: .zenSuccess, iconSource: .hugeIcon(.chartBar), comparisonValue: "-2.1K", comparisonDetail: "(-12%)", trend: .down),
        ZenMetricValue(label: "CTR", value: "4%", iconSource: .hugeIcon(.percent), comparisonValue: "+0.5%", comparisonDetail: "(+15%)", trend: .up),
        ZenMetricValue(label: "Position", value: "16", tint: .zenWarning, iconSource: .hugeIcon(.arrowUpRight), comparisonValue: "-2.2", comparisonDetail: "(-13%)", trend: .up, comparisonLogic: .lessIsBetter),
    ])
    .padding()
