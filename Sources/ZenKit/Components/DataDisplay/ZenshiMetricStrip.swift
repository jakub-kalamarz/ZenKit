...
#Preview {
    ZenMetricStrip(values: [
        ZenMetricValue(label: "Clicks", value: "694", tint: .zenAccent, iconSource: .system("cursorarrow.click.2"), comparisonValue: "+120", comparisonDetail: "(+20%)", trend: .up),
        ZenMetricValue(label: "Impressions", value: "17.8K", tint: .zenSuccess, iconSource: .system("chart.bar"), comparisonValue: "-2.1K", comparisonDetail: "(-12%)", trend: .down),
        ZenMetricValue(label: "CTR", value: "4%", iconSource: .system("percent"), comparisonValue: "+0.5%", comparisonDetail: "(+15%)", trend: .up),
        ZenMetricValue(label: "Position", value: "16", tint: .zenWarning, iconSource: .system("arrow.up.right"), comparisonValue: "-2.2", comparisonDetail: "(-13%)", trend: .up, comparisonLogic: .lessIsBetter),
    ])
    .padding()
